...
export const SECTIONS_SYMBOLS: DocSection[] = [
  {
    ...
    entries: [
      {
        tex: String.raw`f \colon \mathbb{R} \to \mathbb{R}`,
        label: 'Function type',
      },
  ...
  },
  {
    ...
    entries: [
      {
        tex: String.raw`\hat{x},\quad \bar{x},\quad \vec{v}`,
        label: 'Hat, bar, vec',
      },
      { tex: String.raw`\dot{x},\quad \ddot{x}`, label: 'Time derivatives' },
      {
        tex: String.raw`\tilde{x},\quad \widetilde{ABC}`,
        label: 'Tilde / widetilde',
      },
      {
        tex: String.raw`\underbrace{a + b + c}_{\text{sum}}`,
        label: 'Underbrace with label',
      },
      {
        tex: String.raw`\overbrace{1 + 2 + \cdots + n}^{n\text{ terms}}`,
        label: 'Overbrace',
      },
      { tex: String.raw`\boxed{E = mc^2}`, label: 'Boxed formula' },
      {
        tex: String.raw`\cancel{x} + \bcancel{y}`,
        label: 'Strikethrough (cancel)',
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        label: 'Round brackets (pmatrix)',
      },
      {
        tex: String.raw`\begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}`,
        label: 'Square brackets — identity',
      },
      {
        tex: String.raw`\begin{vmatrix} a & b \\ c & d \end{vmatrix} = ad - bc`,
        label: 'Determinant',
      },
      {
        tex: String.raw`\mathbf{v} = \begin{pmatrix} x \\ y \\ z \end{pmatrix}`,
        label: 'Column vector',
      },
      {
        tex: String.raw`A^{-1} = \frac{1}{\det A}\begin{pmatrix} d & -b \\ -c & a \end{pmatrix}`,
        label: '2×2 inverse',
      },
      {
        tex: String.raw`\mathbf{A}\mathbf{x} = \lambda\mathbf{x}`,
  ...
  },
  {
    ...
    entries: [
      ...
      {
        tex: String.raw`\gamma = \frac{1}{\sqrt{1 - v^2/c^2}}`,
  ...
  },
  {
    ...
    entries: [
      ...
      {
        tex: String.raw`P(A \mid B) = \frac{P(B \mid A)\,P(A)}{P(B)}`,
        label: "Bayes' theorem",
      },
      {
        tex: String.raw`f(x) = \frac{1}{\sigma\sqrt{2\pi}}\,e^{-\frac{(x-\mu)^2}{2\sigma^2}}`,
        label: 'Gaussian distribution',
      },
      {
        tex: String.raw`\zeta(s) = \sum_{n=1}^{\infty} \frac{1}{n^s}`,
        label: 'Riemann zeta function',
      },
      {
        tex: String.raw`1 + \frac{1}{4} + \frac{1}{9} + \cdots = \frac{\pi^2}{6}`,
        label: 'Basel problem',
      },
      {
        tex: String.raw`(a+b)^n = \sum_{k=0}^{n}\binom{n}{k}a^k b^{n-k}`,
